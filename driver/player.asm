...
;RAM
_mus_paused			EQU _RAM + 0
_mus_step			EQU _mus_paused + 1
_mus_song			EQU _mus_step + 1
_mus_enabled1		EQU _mus_song + 2
_mus_enabled4		EQU _mus_enabled1 + 1
_mus_done1			EQU _mus_enabled4 + 1
_mus_done2			EQU _mus_done1 + 1
_mus_done3			EQU _mus_done2 + 1
_mus_done4			EQU _mus_done3 + 1
_mus_freq1			EQU _mus_done4 + 1
_mus_freq2			EQU _mus_freq1 + 2
_mus_freq3			EQU _mus_freq2 + 2
_mus_freq4			EQU _mus_freq3 + 2
_mus_data1			EQU _mus_freq4 + 1
_mus_data2			EQU _mus_data1 + 2
_mus_data3			EQU _mus_data2 + 2
_mus_data4			EQU _mus_data3 + 2
_mus_data1_bak		EQU _mus_data4 + 2
_mus_data2_bak		EQU _mus_data1_bak + 2
_mus_data3_bak		EQU _mus_data2_bak + 2
_mus_data4_bak		EQU _mus_data3_bak + 2
_mus_wave			EQU _mus_data4_bak + 2
_mus_loop1			EQU _mus_wave + 2
_mus_loop2			EQU _mus_loop1 + 2
_mus_loop3			EQU _mus_loop2 + 2
_mus_loop4			EQU _mus_loop3 + 2
_mus_octave1		EQU _mus_loop4 + 2
_mus_octave2		EQU _mus_octave1 + 1
_mus_octave3		EQU _mus_octave2 + 1
_mus_octave4		EQU _mus_octave3 + 1
_mus_length1		EQU _mus_octave4 + 1
_mus_length2		EQU _mus_length1 + 1
_mus_length3		EQU _mus_length2 + 1
_mus_length4		EQU _mus_length3 + 1
_mus_volume1		EQU _mus_length4 + 1
_mus_volume2		EQU _mus_volume1 + 1
_mus_volume3		EQU _mus_volume2 + 1
_mus_volume4		EQU _mus_volume3 + 1
_mus_env1			EQU _mus_volume4 + 1
_mus_env2			EQU _mus_env1 + 1
_mus_env4			EQU _mus_env2 + 1
_mus_pan1			EQU	_mus_env4 + 1
_mus_pan2			EQU	_mus_pan1 + 1
_mus_pan3			EQU	_mus_pan2 + 1
_mus_pan4			EQU	_mus_pan3 + 1
_mus_duty1			EQU	_mus_pan4 + 1
_mus_duty2			EQU	_mus_duty1 + 1
_mus_wait1			EQU	_mus_duty2 + 1
_mus_wait2			EQU	_mus_wait1 + 1
_mus_wait3			EQU	_mus_wait2 + 1
_mus_wait4			EQU	_mus_wait3 + 1
_mus_target1		EQU	_mus_wait4 + 1
_mus_target2		EQU	_mus_target1 + 2
_mus_target4		EQU	_mus_target2 + 2
_mus_slide1			EQU	_mus_target4 + 1
_mus_slide2			EQU	_mus_slide1 + 1
_mus_slide4			EQU	_mus_slide2 + 1
_mus_porta1			EQU	_mus_slide4 + 1
_mus_porta2			EQU	_mus_porta1 + 1
_mus_porta4			EQU	_mus_porta2 + 1
_mus_vib_speed1		EQU	_mus_porta4 + 1
_mus_vib_speed2		EQU	_mus_vib_speed1 + 1
_mus_vib_table1		EQU	_mus_vib_speed2 + 1
_mus_vib_table2		EQU	_mus_vib_table1 + 2
_mus_vib_pos1		EQU	_mus_vib_table2 + 2
_mus_vib_pos2		EQU	_mus_vib_pos1 + 1
_mus_vib_delay1		EQU	_mus_vib_pos2 + 1
_mus_vib_delay2		EQU	_mus_vib_delay1 + 1
_mus_noise_step		EQU	_mus_vib_delay2 + 1
_mus_po1			EQU	_mus_noise_step + 1
_mus_po2			EQU	_mus_po1 + 1
_mus_po3			EQU	_mus_po2 + 1
_mus_macro1			EQU	_mus_po3 + 1
_mus_macro2			EQU	_mus_macro1 + 1
_mus_macro3			EQU	_mus_macro2 + 1
_mus_macro4			EQU	_mus_macro3 + 1
_mus_rep1			EQU	_mus_macro4 + 1
_mus_rep2			EQU	_mus_rep1 + 8
_mus_rep3			EQU	_mus_rep2 + 8
_mus_rep4			EQU	_mus_rep3 + 8
_mus_repeats1		EQU	_mus_rep4 + 8
_mus_repeats2		EQU	_mus_repeats1 + 4
_mus_repeats3		EQU	_mus_repeats2 + 4
_mus_repeats4		EQU	_mus_repeats3 + 4
_mus_rep_depth1		EQU	_mus_repeats4 + 4
_mus_rep_depth2		EQU	_mus_rep_depth1 + 1
_mus_rep_depth3		EQU	_mus_rep_depth2 + 1
_mus_rep_depth4		EQU	_mus_rep_depth3 + 1
...
SECTION "start", ROM0[$0100]
    ...
    ROM_HEADER  "MMLGB          ", $80, $03, ROM_MBC1, ROM_SIZE_128KBYTE, RAM_SIZE_0KBYTE
...
INCLUDE "driver/utils.asm"
INCLUDE "driver/freq.asm"
INCLUDE "driver/music.asm"
